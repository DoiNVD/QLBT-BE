            ...
            lock (Commons.LockObjectState)
            {
                ...
                else if (uow.thietBiSuaChuas.Exists(x => x.MaThietBiSuaChua == data.MaThietBiSuaChua && !x.IsDeleted))
                {
                    ...
                    foreach (var item in data.lstLois)
                    {
                        ...
                        item.LoiThietBiSuaChua_Id = thietbisuachua[0].Id;
